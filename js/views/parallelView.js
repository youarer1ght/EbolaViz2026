...
export function initParallel(dom, store, data) {
  ...
  function buildOption(state) {
    ...
    return {
      ...
      // ── Header labels rendered above the parallel area via graphic ──
      //     Positions as % of chart width, aligned with the 5 evenly-spaced axes.
      //     This keeps labels completely separate from crossing lines.
      graphic: [
        { type: 'text', left: '9.5%',  top: 8, z: 100,
          style: { text: '人口密度', fontSize: 12, fontWeight: 'bold', fill: '#333',
                   fontFamily: '-apple-system, "Noto Sans SC", sans-serif' } },
        { type: 'text', left: '29%',   top: 8, z: 100,
          style: { text: '医生/10万人', fontSize: 12, fontWeight: 'bold', fill: '#333',
                   fontFamily: '-apple-system, "Noto Sans SC", sans-serif' } },
        { type: 'text', left: '48.5%', top: 8, z: 100,
          style: { text: '确诊数', fontSize: 12, fontWeight: 'bold', fill: '#333',
                   fontFamily: '-apple-system, "Noto Sans SC", sans-serif' } },
        { type: 'text', left: '68%',   top: 8, z: 100,
          style: { text: '死亡率(%)', fontSize: 12, fontWeight: 'bold', fill: '#333',
                   fontFamily: '-apple-system, "Noto Sans SC", sans-serif' } },
        { type: 'text', left: '87.5%', top: 8, z: 100,
          style: { text: '床位/万人', fontSize: 12, fontWeight: 'bold', fill: '#333',
                   fontFamily: '-apple-system, "Noto Sans SC", sans-serif' } },
        // Subtle separator line below header
        { type: 'line', z: 99,
          shape: { x1: '8%', y1: 28, x2: '92%', y2: 28 },
