    ...
    return {
      ...
      parallelAxis: [
        { dim: 0, name: '人口密度', type: 'value', max: Math.max(1, maxValues[0]),
          axisLabel: { fontSize: 8, formatter: v => v > 500 ? (v/1000).toFixed(1)+'k' : v },
          nameTextStyle: { fontSize: 9 } },
        { dim: 1, name: '医生/10万人', type: 'value', max: Math.max(1, maxValues[1]),
          axisLabel: { fontSize: 8 }, nameTextStyle: { fontSize: 9 } },
      ...
      parallel: {
        left: 60, right: 60, top: 36, bottom: 20,
        parallelAxisDefault: {
          axisLabel: { fontSize: 8 }, nameTextStyle: { fontSize: 9 },
          nameLocation: 'middle', nameGap: 18,
        },
      },
      series: [{
        type: 'parallel',
